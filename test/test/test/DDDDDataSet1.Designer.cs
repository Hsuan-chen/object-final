...
namespace test {
    ...
    public partial class DDDDDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DDDDDataSet1.xsd";
        ...
        public partial class DATA1DataTable : global::System.Data.TypedTableBase<DATA1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DATA1Row AddDATA1Row(string 姓名, string 電話, string 居住縣市, string _E_mail) {
...
namespace test.DDDDDataSet1TableAdapters {
    ...
    public partial class DATA1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `DATA1` (`姓名`, `電話`, `居住縣市`, `E-mail`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `DATA1` SET `姓名` = ?, `電話` = ?, `居住縣市` = ?, `E-mail` = ? WHERE ((`姓名` = ?)" +
                " AND ((? = 1 AND `電話` IS NULL) OR (`電話` = ?)) AND ((? = 1 AND `居住縣市` IS NULL) OR" +
                " (`居住縣市` = ?)) AND ((? = 1 AND `E-mail` IS NULL) OR (`E-mail` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT 姓名, 電話, 居住縣市, [E-mail] FROM DATA1";
        ...
        public virtual int Delete(string Original_姓名, string Original_電話, string Original_居住縣市, string _Original_E_mail) {
            if ((Original_姓名 == null)) {
        ...
        public virtual int Insert(string 姓名, string 電話, string 居住縣市, string _E_mail) {
            if ((姓名 == null)) {
        ...
        public virtual int Update(string 姓名, string 電話, string 居住縣市, string _E_mail, string Original_姓名, string Original_電話, string Original_居住縣市, string _Original_E_mail) {
            if ((姓名 == null)) {
                throw new global::System.ArgumentNullException("姓名");
            }
            else {
            ...
            if ((Original_居住縣市 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_居住縣市));
            }
            if ((_Original_E_mail == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string 電話, string 居住縣市, string _E_mail, string Original_姓名, string Original_電話, string Original_居住縣市, string _Original_E_mail) {
            return this.Update(Original_姓名, 電話, 居住縣市, _E_mail, Original_姓名, Original_電話, Original_居住縣市, _Original_E_mail);
        }
    }
